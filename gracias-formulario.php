...
<body>
    ...
    <style>
#gracias-formulario .container-fluid {
    height: 100vh;
    display: flex;
...
.card {
    ...
    width: 100%;
    padding: 20px;
    text-align: center; /* Asegúrate de que el texto y las imágenes estén centrados */
}
...
.logopsico {
    max-width: 150px;
    display: block; /* Cambia a block para mejorar el centrado */
    margin: 0 auto; /* Agrega margen automático para centrar la imagen */
}
@media only screen and (min-width: 320px) and (max-width: 767px) {
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100 bg-primary">
        ...
        <img src="assets/images/logos/diagnostico-y-tratamiento-urologico-en-cdmx.png" alt="Logotipo" class="mb-3 img-fluid logopsico">
            <h1>¡Gracias!</h1>
            <p><strong>La información del formulario ha sido recibida.</strong></p>
