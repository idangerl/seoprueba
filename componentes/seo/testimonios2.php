        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                <div class="testimonial-two__left">
                    ...
                    <?php echo highlightKeywordAndInterlinks($testimonio['texto'], $home['keyword'], $interlinks); ?>
                                </p>
                            </div>
                        </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="testimonial-two__right">
                    <div class="testimonial-two__img">
                        <img src="assets/images/resources/testimonios/testimonios-de-servicios-de-urologia-en-cdmx.jpg" alt="Pacientes satisfechos con tratamientos urológicos en CDMX">
                    </div>
                </div>
            </div>
        </div>
