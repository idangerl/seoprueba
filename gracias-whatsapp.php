...
<body>
    ...
    <style>
#gracias-whatsapp .container-fluid {
    height: 100vh;
    display: flex;
...
@media only screen and (min-width: 320px) and (max-width: 767px) {
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100 bg-primary">
        <div class="card p-5">
            ...
            <img src="assets/images/logos/diagnostico-y-tratamiento-urologico-en-cdmx.png" alt="Logotipo" class="mb-3 logopsico">
            <h1>¡Gracias!</h1>
            <p><strong>Hemos recibido tu mensaje por WhatsApp.</strong></p>
